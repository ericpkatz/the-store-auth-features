          ...
          products.map( product => {
            ...
            return (
              <li key={ product.id }>
                ...
                {
                  auth.id ? <Favorite product={ product } favorite = { favorites.find(favorite => favorite.product_id === product.id)} createFavorite={  createFavorite } removeFavorite={ removeFavorite }/>: null
                }
              </li>
            );
          })
